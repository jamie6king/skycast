...
export default function Weather() {
    ...
    const [airQualityForecastLoading, setAirQualityForecastLoading] =
        useState(true);
    ...
    useEffect(() => {
        ...
        const fetchWeatherData = async () => {
            // urls
            const weatherUrl =
                process.env.REACT_APP_LOCAL == "yes"
            ...
            const airQualityUrl =
                process.env.REACT_APP_LOCAL == "yes"
                    ? "http://localhost:3000/airquality"
                    : "/airquality";
            const airQualityForecastUrl =
                process.env.REACT_APP_LOCAL == "yes"
                    ? "http://localhost:3000/forecast/airquality"
                    : "/forecast/airquality";
            ...
            try {
                ...
                const airQualityForecastResponse = await fetch(
                    airQualityForecastUrl,
                    {
                        method: "POST",
                        headers: { "Content-Type": "application/json" },
                        body: JSON.stringify({ lat, lon }),
                ...
                const airQualityForecastData =
                    await airQualityForecastResponse.json();
    ...
    useEffect(() => {
        if (localTime)
            setLocalDayOrNight(
                localTime.hour > 6 && localTime.hour < 20 ? "d" : "n"
            );
    }, [localTime]);
                ...
                {mainLoading ? (
                    ...
                    <>
                        ...
                        >
                            ...
                            <p>
                                {data.name}, {getName(data.sys.country, "en")}
                            </p>
                        ...
                        <div className={Styles.mainTemp}>
                            <div className={Styles.mainTempPanel}>
                                <div>
                                    <i
                                        className={`owf owf-${data.weather[0].id}-${localDayOrNight} owf-3x`}
                                    />
                                        ...
                                        labels={{
                                            valueLabel: {
                                                formatTextValue: (string) => {
                                                    return `${parseFloat(string).toFixed(1)} MPH`;
                                                },
                                            },
                                        }}
                                    />
                                ...
                                >
                                    ...
                                    <GaugeComponent
                                        ...
                                        labels={{
                                            valueLabel: {
                                                formatTextValue: (string) => {
                                                    return `${parseFloat(string).toFixed(1)} KM`;
                                                },
                                            },
                                        }}
                                    />
                ...
                {forecastLoading || airQualityForecastLoading ? (
                    ...
                    <>
                        <div className={Styles.forecast}>
                            ...
                            <div
                                className={Styles.forecastBox}
                                data-testid="forecasts"
                            >
                                {forecastData.list.map((day) => {
                                    const localDate = DateTime.fromSeconds(
                                        day.dt
                                    );
                                    const date = localDate.setZone(
                                        localTime.zone
                                    );
                                    const dateDayOrNight =
                                        date.hour > 6 && date.hour < 20
                                            ? "d"
                                            : "n";
                                    ...
                                    return (
                                        <div key={day.dt}>
                                            ...
                                            <i
                                                className={`owf owf-${day.weather[0].id}-${dateDayOrNight} owf-5x`}
                                            />
                            ...
                            <div
                                className={Styles.forecastBox}
                                data-testid="airqualityforecast"
                            >
